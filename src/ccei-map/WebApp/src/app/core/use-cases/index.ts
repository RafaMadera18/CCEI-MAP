// Exporta solo las implementaciones (clases)
export { CalculateSpaceBoundsUseCaseImpl } from "./calculate-space-bounds";
export { GetAllBuildingsUseCaseImpl } from "./get-all-buildings";
...
export type { GetAllBuildingsUseCase } from "./get-all-buildings";
